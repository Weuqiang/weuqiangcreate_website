---
title: "实例对象与 new 命令"
description: "JavaScript 语言具有很强的面向对象编程能力，本章介绍 JavaScript 面向对象编程的"
---
...
- [函数类型](/docs/软件工程/Web前端/JavaScript/types/function)

## 核心概念

new 操作符创建一个新对象，将其原型指向构造器的 prototype，再以该对象为 this 调用构造器。若构造器显式返回对象，则覆盖默认实例。
...
new 把实例的 __proto__ 链到构造器 prototype；构造器返回对象会覆盖默认实例。
