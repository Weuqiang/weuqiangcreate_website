...
- [异步概览](/docs/软件工程/Web前端/JavaScript/async/general)
...
- 跨主题关联：[HTTP 与网络安全](../../../../../计算机科学基础/计算机网络/HTTP与网络安全)（XHR 发出的正是 HTTP 报文；同源策略与 CORS 在此生效）
- 跨语言对照：[Python urllib](../../../../../编程语言/Python/Python标准库/13网络和进程间通信/urllib)（同一件事的脚本端做法：发请求、读响应、处理异常）
