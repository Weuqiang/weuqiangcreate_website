...
![image-20250411193321831](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20250411193321831.png)

*f*(*x*)=1+*e*−*x*1

多个解释变量会影响因变量的值。要对此类输入数据集建模，逻辑回归公式假设不同自变量之间存在线性关系。您可以修改 sigmoid 函数并按如下公式计算最终输出变量

![image-20250411193346397](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20250411193346397.png)

*y*=*f*(*β*0+*β*1*x*1+*β*2*x*2+…*β**n**x**n*)
