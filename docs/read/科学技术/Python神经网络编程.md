...
sidebar_position: 9
title: 🍻Python神经网络编程
douban: https://book.douban.com/subject/30192800/
---
...
- [人工智能：学习路线图](/docs/人工智能/) — 书中手搓的神经网络，正是「机器学习 → 深度学习」的入口。
- [Python 语言基础](/docs/编程语言/Python/) — 本书代码用 Python，先看语言地基更高效。
...
- [豆瓣读书（精确页）](https://book.douban.com/subject/30192800/)
- [微信读书搜索](https://weread.qq.com/search?keyword=Python神经网络编程)
- [国家图书馆 OPAC 检索](https://opac.nlc.cn/search?q=Python神经网络编程)
