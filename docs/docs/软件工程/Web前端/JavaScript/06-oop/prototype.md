---
title: "对象的继承"
description: "面向对象编程很重要的一个方面，就是对象的继承。A 对象通过继承 B 对象，就能直接拥有 B 对象的所"
---
...
- [严格模式](../strict)
- [this 关键字](../this)
- 跨主题关联·抽象：[设计模式](../../../../../软件工程/工程实践/设计模式)（往原型链上挂方法，就是"面向接口编程"的动态语言版本）
- 跨语言抽象对照：[Java 接口与多态](../../../../../编程语言/Java/语言基础/面向对象与核心语法)（类继承树 + 显式接口）· [Python 类与对象](../../../../../编程语言/Python/20类与对象)（同为动态语言，对照两套对象模型）
