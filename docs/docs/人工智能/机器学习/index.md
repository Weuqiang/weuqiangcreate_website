...
- [数学基础：矩阵与线性方程组](../../数学基础/线性代数/矩阵与线性方程组) — 神经网络运算的数学基础。
- [数学基础：概率基础与随机变量](../../数学基础/概率与统计/概率基础与随机变量) — 贝叶斯与统计推断的根基。
- [编程语言：Python 入门](../../编程语言/Python/0基础语法) — 机器学习的主流实现语言。
- [数据结构与算法：动态规划](../../编程外的基础/数据结构与算法/高级算法/动态规划) — 算法思想在建模中的运用。