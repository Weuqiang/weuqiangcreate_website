---
title: "数组"
description: "数组（array）是按次序排列的一组值。每个值的位置都有编号（从0开始），整个数组用方括号表示。"
---
...
- [JavaScript 简介](/docs/软件工程/Web前端/JavaScript/basic/introduction)
...
- Axel Rauschmayer, [Arrays in JavaScript](https://www.2ality.com/2012/12/arrays.html)
